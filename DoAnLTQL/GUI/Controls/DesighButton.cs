...
using System.ComponentModel;// để tạo properties tự định nghĩa cho toolbox
...
namespace GUI
{
    public class DesignButton : Button
    {
        ...
        public DesignButton()
        {
            ...
            this.Resize += new EventHandler(Button_Resize);//nhận lại giá trị Height mới nếu borderRadius > this.Height
        }

        private void Button_Resize(object sender, EventArgs e)
        {
            if (borderRadius > this.Height)
                BorderRadius = this.Height;//truyền lại giá trị cho method get,set : BorderRadius
        }
